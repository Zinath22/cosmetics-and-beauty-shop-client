const Contact = () => {
   ...
   <div className="  ">
    <h1 className="text-red-500 text-3xl mb-5">Contact Us</h1>
      <h1 className="text-2xltext-red-500 mb-2" data-aos="flip-left">phone </h1>
  ...
  <h2>Message Us</h2>
  <input className="border p-1 border-red-300" placeholder="Name" type="name" name="" id="" />
<input className="border p-1 border-red-300" placeholder="Email" type="email" name="" id="" />
<textarea
